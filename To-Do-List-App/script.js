  ...
  items.forEach((item) => {
    ...
    if (
      ...
      item.querySelector("[data-edit]").addEventListener("click", function (e) {
        ...
        console.log(document.querySelector("#objIndex").value);
        console.log(itemData);
      ...
      item
        ...
        .addEventListener("click", function (e) {
          ...
          if (confirm("Are you sure you want to remove this item?")) {
            ...
            removeItem(item);
            setLocalStorage(todoItems);
            alertMessage("Item has been deleted", "alert-alert-success");
            const filter = todoItems.filter((item) => item != itemData);
            console.log(filter);
            return filter;
          }
        });
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (itemName.length === 0) {
      ...
      if (currentItemIndex) {
        ...
        console.log(currentItemIndex, itemName);
