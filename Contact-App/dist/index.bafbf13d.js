...
var _addContactView = require("./views/addContactView");
var _addContactViewDefault = parcelHelpers.interopDefault(_addContactView);
var _contactContainerView = require("./views/contactContainerView");
var _contactContainerViewDefault = parcelHelpers.interopDefault(_contactContainerView);
...
const controlContactDelete = (id)=>{
    ...
    if (Array.isArray(list)) {
        ...
        // console.log(list);
        _contactContainerViewDefault.default.render(list);
...
const hanleSearch = (e)=>{
    ...
    e.preventDefault();
    const { query  } = _searchViewDefault.default;
...
const search = (query)=>{
    ...
    console.log(list);
    let results = [];
    if (Array.isArray(list)) list.forEach((contact)=>{
        if (contact.name.includes(query) || contact.phone.toString().includes(query)) results.push(contact);
    });
    console.log(results);
    return results;
};
const handleSearchClear = (e)=>{
    ...
    _searchViewDefault.default.toggleButtons();
    _searchViewDefault.default.clearForm();
    location.hash = "";
};
const controlHashChange = ()=>{
    ...
    if (typeof query !== "undefined" && query.length > 0) _contactContainerViewDefault.default.render(results);
    else _contactContainerViewDefault.default.render(getContactFromLs());
};
const controlAddContact = (event)=>{
    event.preventDefault();
    const { Name , Email , Person  } = _addContactViewDefault.default;
    const newContact = new _model.ContactPerson(Name, Email, Person);
    newContact.saveContactInLs();
    _addContactViewDefault.default.clearForm();
    _contactContainerViewDefault.default.pushContactIntoContainer(newContact);
};
const init = ()=>{
    _addContactViewDefault.default.addContactSubmitListener(controlAddContact);
    _contactContainerViewDefault.default.addDeleteListener(controlContactDelete);
    _contactContainerViewDefault.default.render(getContactFromLs());
    _searchViewDefault.default.addSubmitEvent(hanleSearch);
    window.onhashchange = controlHashChange;
    _searchViewDefault.default.addHandleClear(handleSearchClear);
};
init();

},{"./model":"dEDha","./views/addContactView":"5c0AW","./views/contactContainerView":"iAIIh","./views/searchView":"kBGZg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dEDha":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state
);
parcelHelpers.export(exports, "ContactPerson", ()=>ContactPerson
);
let state = {
    isSearching: false
};
...
},{}],"5c0AW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = new AddContactView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iAIIh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = new ContactContainerView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kBGZg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gvsso","gCE4p"], "gCE4p", "parcelRequirefa9f")
